  ...
  render(){
    return(
      <div className='PicLink-root'>
        <ul>
          <li><a href='/' target='_blank'><img alt='banner01' src={banner01}/></a></li>
          <li><a href='/' target='_blank'><img alt='banner02' src={banner02}/></a></li>
          <li><a href='/' target='_blank'><img alt='banner03' src={banner03}/></a></li>
          <li><a href='/' target='_blank'><img alt='banner04' src={banner04}/></a></li>
          <li><a href='/' target='_blank'><img alt='banner05' src={banner05}/></a></li>
        </ul>
      </div>
    )
  }
